			...
			<div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
				...
				<div class="offcanvas-body">
					<ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
						...
						<li class="nav-item">
							<a href="register.php" class="nav-link"><i class="bi bi-person-plus me-2"></i>Registar</a>
						</li>
					</ul>
				</div>
			</div>
			...
			<div class="auth-card">
				...
				<form method="POST">
					...
					<div class="form-check">
						...
						<label for="check" class="form-check-label">Manter sessão iniciada</label>
					</div>
					<button type="submit" class="btn btn-primary w-100" name="Login">Entrar</button>
				</form>
				<div class="auth-footer">
					<p>Não tens conta?</p>
					<a href="register.php">Regista-te agora</a>
				</div>
			</div>
		</div>
	</main>
